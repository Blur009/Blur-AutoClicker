        ...
        <div className="settings-wrapper">
          ...
          >
            {resettingStats ? "Clearing..." : "Clear"}
                ...
                <div className="settings-row">
                    <div className="settings-label-group">
                        <span className="settings-label">Minimise To System Tray</span>
                        <span className="settings-sublabel">
                            Keeps the app running in the system tray when minimized.
                        </span>
                    </div>
                    <div className="settings-seg-group">
                        {["On", "Off"].map((o) => (
                            <button
                                key={o}
                                className={`settings-seg-btn ${(settings.minimiseToSystemTray ? "On" : "Off") === o ? "active" : ""}`}
                                onClick={() => update({ minimiseToSystemTray: o === "On" })}
                            >
                                {o}
                            </button>
                        ))}
