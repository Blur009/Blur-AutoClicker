...
Past versions will not recieve bug fixes. The current version is the only "supported" one. Please do not ask me to fix something in an older version of the app.
